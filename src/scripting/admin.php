  ...
  <body class="bg-light">
    ...
    <div class="container">
      <div class="py-5 text-center">
        ...
        <h2>Administration</h2><link rel="shortcut icon" href="/fileadmin/template/img/htl.png" type="image/png">
        <p></p>
      </div>
        <div class="col-md-8 order-md-1 mx-auto">
          <h4 class="mb-3">Anmeldungszeitraum</h4>
          <form class="needs-validation" novalidate="" action="dyn.php" method="post">
	...
	<hr class="mb-4">
          ...
          <!------------------- Button zum PDF ----------------->
            <hr class="mb-4">
            <h4 class="mb-3">Daten herunterladen</h4>

            <div class="row">
                <!-- CSV-Datei -->
                <div class="col-md-12 mb-3">
                    <form class="needs-validation" novalidate="" action="download_CSV.php" method="post">                     <!-- Welche Datei ?!?!?!?!?!??!?!? -->
                        <button class="btn btn-primary btn-lg btn-block" type="submit">CSV</button>
                    </form>
                </div>
            </div>
